      ...
      <div className="max-w-6xl mx-auto">
        <div className="relative overflow-hidden rounded-2xl md:rounded-3xl bg-primary text-primary-foreground p-8 md:p-12 lg:p-20">
          <div className="relative z-10 text-center">
            ...
            <p className="text-base md:text-lg lg:text-xl mb-8 md:mb-12 opacity-90 max-w-2xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
              <Button
                size="lg"
                variant="secondary"
                className="rounded-full px-6 md:px-10 py-4 md:py-6 text-sm md:text-base font-medium"
              >
                Launch App
              </Button>
              <Button
                size="lg"
                variant="outline"
                className="rounded-full px-6 md:px-10 py-4 md:py-6 text-sm md:text-base font-medium bg-transparent border-2 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary"
              >
                View Documentation
              </Button>
            </div>
