...
const ChatPane = forwardRef<{ insertTemplate: (content: string) => void }, ChatPaneProps>(
  function ChatPane({ conversation, onSend, onEditMessage, onResendMessage, isThinking, onPauseThinking }, ref) {
    const [editingId, setEditingId] = useState<string | null>(null);
    const [draft, setDraft] = useState("");
    const [busy, setBusy] = useState(false);
    const composerRef = useRef<{ insertTemplate: (content: string) => void; focus: () => void }>(null);
