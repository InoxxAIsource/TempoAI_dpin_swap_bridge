...
const DePIN = () => {
  ...
  return (
    <PageLayout>
      ...
      {/* Stats Grid with futuristic container */}
      <section className="px-4 md:px-6 lg:px-12 py-6 md:py-8">
        <div className="max-w-6xl mx-auto relative">
          {/* Futuristic frame */}
          <div className="absolute -inset-4 border-2 border-primary/10 rounded-3xl pointer-events-none">
            <div className="absolute top-0 left-0 w-20 h-20 border-l-2 border-t-2 border-primary/40" />
            <div className="absolute top-0 right-0 w-20 h-20 border-r-2 border-t-2 border-primary/40" />
            <div className="absolute bottom-0 left-0 w-20 h-20 border-l-2 border-b-2 border-primary/40" />
            <div className="absolute bottom-0 right-0 w-20 h-20 border-r-2 border-b-2 border-primary/40" />
          </div>
      ...
      {/* World Map Section with futuristic frame */}
      <section className="px-4 md:px-6 lg:px-12 py-6 md:py-8 relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="mb-6 relative">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-primary via-primary to-primary/60 bg-clip-text text-transparent">
      ...
      {/* Process Flow with enhanced container */}
      <section className="px-4 md:px-6 lg:px-12 py-6 md:py-8 relative overflow-hidden">
        {/* Particle background */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center justify-between mb-6 gap-2 relative">
                {/* Decorative line */}
                <div className="absolute -left-4 top-1/2 -translate-y-1/2 w-1 h-16 bg-gradient-to-b from-transparent via-primary to-transparent rounded-full" />
                ...
                <Button 
                  ...
                  className="gap-2 text-sm md:text-base bg-primary/90 hover:bg-primary shadow-lg shadow-primary/20"
