      ...
      >
        <Dialog>
          <DialogTrigger asChild>
            <div className="relative group cursor-pointer my-8 rounded-xl border-2 border-border bg-card/50 overflow-hidden hover:border-primary/50 transition-colors p-4">
              <img 
